Description: Follow practical Spring AI Playground tutorials for creating tools, connecting MCP servers, indexing documents, and running agentic chat with RAG.
...
If you published `getCurrentTime`, this is a good first validation prompt.
